...
var randomBlockchainAddresses = require("random-blockchain-addresses");
var BlockhainMonitor = /** @class */ (function () {
    function BlockhainMonitor(config) {
        ...
        var provider = new web3.providers.WebsocketProvider(this.providers[this.networkType]);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, randomBlockchainAddresses.getAddresses(20, this.networkType)];
                    case 1:
                        addrs = _a.sent();
                        console.debug(addrs);
                        return [2 /*return*/];
